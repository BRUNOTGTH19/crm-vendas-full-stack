...
def list_reminders(
    ...
    """Central de cobranças: vendas vencidas ou que vencem hoje.

    Integra-se ao alerta de vencimento do APScheduler (``pending:reminders``).
    """
    return collection_service.list_due_reminders(db)
...
def get_collection_message(
    ...
    """Mensagem de cobrança personalizada + link wa.me para uma venda."""
